...
if(matchupArchive.schemaVersion < 2 || matchupArchive.archiveGameCount !== 885 || matchupArchive.gameCount < 885){
  throw new Error('Matchup archive must retain all 885 completed historical games.');
}
